...
## Chart
```{raw} html
<iframe src="../_static/DASH/normalized_series_chart.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: FRED</p>
```
[Full Screen Chart](../download_chart/DASH/normalized_series_chart.html)
...
| Units                  | Index                                                  |
| HTML Chart             | [HTML](../download_chart/DASH/normalized_series_chart.html)    |
